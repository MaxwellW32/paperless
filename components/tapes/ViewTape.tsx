...
export default function ViewTape({ seenTape, addFunction }: { seenTape: Partial<tape>, addFunction?: () => void }) {
    return (
        <div style={{ display: "grid", alignContent: "flex-start", gap: "1rem", backgroundColor: "rgb(var(--color2))", padding: "1rem", width: "100%", aspectRatio: "1/1", gridTemplateRows: "1fr auto", overflow: "auto" }}>
