...
export default function ShowMore({ label, content, startShowing, allAttributes = { mainDiv: {}, labelDiv: {}, contentDiv: {}, svg: {} } }: { label: string, content: JSX.Element, startShowing?: boolean, allAttributes?: allAttributesType }) {
